...
export const parseTaskAddOptions = (args: Args): TaskAddOptions => v.parse(TaskAddArgsSchema, args);

export const parseTaskFilter = (args: Args): TaskFilter => v.parse(TaskFilterArgsSchema, args);
